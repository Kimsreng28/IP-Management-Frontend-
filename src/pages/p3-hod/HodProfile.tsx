                ...
                <div className="bg-white rounded-xl shadow-lg overflow-hidden">
                    ...
                    <div className="px-4 py-6 sm:px-6 md:px-8 border-b border-gray-200">
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                            <div>
                                <h1 className="text-2xl md:text-3xl font-bold text-gray-900">Head of Department Profile</h1>
                            ...
                            <div className="flex items-center gap-3">
                                <div className="inline-flex justify-center">
                                    <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold bg-orange-100 text-orange-800 border border-orange-200 whitespace-nowrap 
                                    ...
                                    <div className="relative w-32 h-32 rounded-full overflow-hidden border-4 border-white shadow-lg mx-auto">
                                        {profile.image ? (
                                            <img
                                                ...
                                                onError={(e) => {
                                                    const firstLetter = profile.name_en?.[0]?.toUpperCase() || "H";
                                ...
                                <div className="mt-6 md:hidden">
                                    <div className="space-y-3">
                                        ...
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <span className="text-sm text-gray-600">{profile.hodInfo?.departmentInfo?.department_name || 'N/A'}</span>
                                        </div>
                                        {profile.phone && (
                                            <div className="flex items-center space-x-3">
                                        ...
                                        <div className="space-y-6">
                                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    <div className="flex items-center gap-2 p-3 bg-gray-50 rounded-lg border border-gray-200">
                                                        <Building2 className="w-4 h-4 text-gray-400" />
                                                        <span className="text-gray-900">{profile.hodInfo?.departmentInfo?.department_name || 'Not provided'}</span>
                                                    </div>
                                                </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600 mt-1">{profile.hodInfo?.departmentInfo?.department_name || 'Not provided'}</p>
                                    </div>
                                </div>
                            </div>
                            <div className="space-y-4">
                    ...
                    <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
                        ...
                        <div className="relative bg-white px-6 py-5 border-b border-gray-200">
                            <div className="flex items-center gap-3">
                                ...
                                <h2 className="text-2xl font-bold text-gray-900">Edit HOD Profile</h2>
                            </div>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                type="text"
                                                value={profile.hodInfo?.departmentInfo?.department_name || ''}
                                                readOnly
                                                disabled
                                        ...
                                        <p className="text-xs text-gray-500 mt-1">
                                            Department assignment is managed by the administration
                                        </p>
                                    </div>
