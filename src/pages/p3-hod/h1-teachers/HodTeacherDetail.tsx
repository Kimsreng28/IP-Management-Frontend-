...
export default function TeacherViewDetail({
  teacherId,
  isOpen,
  onClose,
}: TeacherDetailProps) {
  ...
  const { fetchTeacherByIdForHod } = useTeacherStore();
  ...
  const fetchTeacherDetail = async () => {
    ...
    setError(null);
    try {
      const teacherData = await fetchTeacherByIdForHod(teacherId);
      ...
      <div className="bg-white rounded-xl shadow-2xl w-full max-w-4xl max-h-[90vh] overflow-hidden flex flex-col">
        ...
        <div className="relative bg-white px-6 py-5 border-b border-gray-200">
          <div className="flex items-center gap-3">
            <h2 className="text-2xl font-bold text-gray-900">Teacher Detail</h2>
          </div>
