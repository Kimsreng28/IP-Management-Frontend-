...
const StudentProfile = () => {
    ...
    const handleSubmit = async () => {
        ...
        if (formData.name_kh !== profile.name_kh) changedData.name_kh = formData.name_kh;
        if (formData.name_en !== profile.name_en) changedData.name_en = formData.name_en;
        if (formData.phone !== profile.phone) changedData.phone = formData.phone;
        if (formData.gender !== profile.gender) changedData.gender = formData.gender;
        if (formData.dob !== profile.dob) changedData.dob = formData.dob;
        if (formData.address !== profile.address) changedData.address = formData.address;
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                            ...
                            <div className="flex items-center gap-3">
                                <div className="inline-flex justify-center">
                                    <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold bg-purple-100 text-purple-800 border border-purple-200 whitespace-nowrap 
                                    ...
                                    <div className="relative w-32 h-32 rounded-full overflow-hidden border-4 border-white shadow-lg mx-auto">
                                        {profile.image ? (
                                            <img
                                                ...
                                                onError={(e) => {
                                                    const firstLetter = profile.name_en?.[0]?.toUpperCase() || "S";
                                ...
                                <div className="mt-6 md:hidden">
                                    <div className="space-y-3">
                                        ...
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <span className="text-sm text-gray-600">{profile.studentInfo?.student_id || 'N/A'}</span>
                                        </div>
                                        {profile.phone && (
                                            <div className="flex items-center space-x-3">
                                        ...
                                        <div className="space-y-6">
                                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    <div className="flex items-center gap-2 p-3 bg-gray-50 rounded-lg border border-gray-200">
                                                        <GraduationCap className="w-4 h-4 text-gray-400" />
                                                        <span className="text-gray-900">{profile.studentInfo?.student_id || 'Not provided'}</span>
                                                    </div>
                                                </div>

                                                {/* Student Year (Read-only) */}
                                                <div className="space-y-2">
                                                    <label className="block text-sm font-medium text-gray-500">Student Year</label>
                                                    <div className="flex items-center gap-2 p-3 bg-gray-50 rounded-lg border border-gray-200">
                                                        <GraduationCap className="w-4 h-4 text-gray-400" />
                                                        <span className="text-gray-900">
                                                            {profile.studentInfo?.student_year ? `Year ${profile.studentInfo.student_year}` : 'Not provided'}
                                                        </span>
                                                    </div>
                                                </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600 mt-1">{profile.studentInfo?.student_id || 'Not provided'}</p>
                                    </div>
                                </div>
                            </div>
                            <div className="space-y-4">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                type="text"
                                                value={profile.studentInfo?.student_id || ''}
                                                readOnly
                                                disabled
                                    ...
                                    <div>
                                        ...
                                        <div className="relative">
                                            ...
                                            <input
                                                type="text"
                                                value={profile.studentInfo?.student_year ? `Year ${profile.studentInfo.student_year}` : ''}
                                                readOnly
                                                disabled
                                                className="w-full pl-12 pr-4 py-2.5 border border-gray-300 rounded-lg bg-gray-100 text-gray-600 cursor-not-allowed outline-none"
                                                title="Student Year cannot be changed"
                                            />
                                        </div>
                                        <p className="text-xs text-gray-500 mt-1">
                                            Student Year cannot be modified
                                        </p>
                                    </div>
