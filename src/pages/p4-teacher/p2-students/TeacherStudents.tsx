...
import StudentViewDetail from "./TeacherStudentDetail";
            ...
            {isLoading ? (
              ...
              students.map((student) => (
                ...
                >
                  ...
                  <td className="px-6 py-4 text-sm text-gray-700">
                    <span
                      className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${student.gender === "Male"
