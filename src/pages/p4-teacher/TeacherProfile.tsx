                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                            ...
                            <div className="flex items-center gap-3">
                                <div className="inline-flex justify-center">
                                    <span className="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold bg-green-100 text-green-800 border border-green-200 whitespace-nowrap 
                                    ...
                                    <div className="relative w-32 h-32 rounded-full overflow-hidden border-4 border-white shadow-lg mx-auto">
                                        {profile.image ? (
                                            <img
                                                ...
                                                onError={(e) => {
                                                    const firstLetter = profile.name_en?.[0]?.toUpperCase() || "T";
                                ...
                                <div className="mt-6 md:hidden">
                                    <div className="space-y-3">
                                        ...
                                        <div className="flex items-center space-x-3">
                                            ...
                                            <span className="text-sm text-gray-600">{profile.teacherInfo?.teacher_id || 'N/A'}</span>
                                        </div>
                                        {profile.phone && (
                                            <div className="flex items-center space-x-3">
                                        ...
                                        <div className="space-y-6">
                                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    <div className="flex items-center gap-2 p-3 bg-gray-50 rounded-lg border border-gray-200">
                                                        <BookOpen className="w-4 h-4 text-gray-400" />
                                                        <span className="text-gray-900">{profile.teacherInfo?.teacher_id || 'Not provided'}</span>
                                                    </div>
                                                </div>
                                                ...
                                                <div className="space-y-2">
                                                    ...
                                                    <div className="flex items-center gap-2 p-3 bg-gray-50 rounded-lg border border-gray-200">
                                                        ...
                                                        <span className="text-gray-900">{profile.teacherInfo?.departmentInfo?.department_name || 'Not provided'}</span>
                                                    </div>
                                                </div>
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600 mt-1">{profile.teacherInfo?.teacher_id || 'Not provided'}</p>
                                    </div>
                                </div>
                                <div className="flex items-center space-x-3">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-gray-600 mt-1">{profile.teacherInfo?.departmentInfo?.department_name || 'Not provided'}</p>
                                    </div>
                                </div>
                            </div>
                            <div className="space-y-4">
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                ...
                                                <input
                                                    type="text"
                                                    value={profile.teacherInfo?.teacher_id || 'Not provided'}
                                                    readOnly
                                                    disabled
                                        ...
                                        <div>
                                            ...
                                            <div className="relative">
                                                ...
                                                <input
                                                    type="text"
                                                    value={profile.teacherInfo?.departmentInfo?.department_name || 'Not provided'}
                                                    readOnly
                                                    disabled
                                                    className="w-full pl-12 pr-4 py-2.5 border border-gray-300 rounded-lg bg-gray-100 text-gray-600 cursor-not-allowed outline-none"
                                                />
                                            ...
                                            <div className="flex gap-3">
                                                {(["Male", "Female", "Other"] as const).map((gender) => (
                                                    <button
                                                        ...
                                                        className={`flex-1 py-2.5 px-4 rounded-lg border transition-colors font-medium ${selectedGender === gender
                                                            ? gender === "Male"
