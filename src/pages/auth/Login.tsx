      ...
      <main className="flex-1 flex flex-col items-center justify-center p-4">
        ...
        <div className="w-full max-w-md bg-white rounded-2xl shadow-md p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              className="w-full h-11 bg-indigo-600 hover:bg-indigo-700 text-white font-medium rounded-lg transition-colors focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2"
            >
              Sign In
            </button>
          </form>
        ...
        {/* Footer */}
        <p className="text-xs text-gray-500 mt-8">© 2025 RTC KcKp. All rights reserved.</p>
      </main>
    </div>
  )
}