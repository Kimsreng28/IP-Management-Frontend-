    ...
    <header className="bg-white shadow-sm border-b border-gray-200">
      <div className="flex items-center justify-between px-6 py-4">
        ...
        <div className="flex items-center gap-4">
          <button onClick={onMenuClick} className="p-2 rounded-md text-gray-600 hover:bg-gray-100 lg:hidden">
        ...
        <div className="flex items-center gap-4">
                ...
                <div className="absolute right-0 mt-2 w-80 bg-white rounded-lg shadow-lg border border-gray-200 z-20">
                  ...
                  <div className="max-h-96 overflow-y-auto">
                    <div className="p-4 hover:bg-gray-50 border-b border-gray-100 cursor-pointer">
                      <p className="text-sm text-gray-800">New student registered</p>
                      <p className="text-xs text-gray-500 mt-1">5 minutes ago</p>
                    </div>
                    <div className="p-4 hover:bg-gray-50 border-b border-gray-100 cursor-pointer">
                      <p className="text-sm text-gray-800">Attendance report ready</p>
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="hidden md:block">
              ...
              <p className="text-xs text-gray-600 leading-tight">{formatRole(userRole)}</p>
            </div>
          </div>
        </div>
      </div>
